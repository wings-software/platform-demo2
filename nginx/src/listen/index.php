...
<head>
    ...
    <title>The Clap Clap Demo!</title>
    <link href="https://fonts.googleapis.com/css?family=Fira+Sans:400,400i,500,700" rel="stylesheet">
    <link href="sound-detector/dist/style.css" rel="stylesheet">
    <link rel="stylesheet" href="dist/css/style.css">
    <script src="https://unpkg.com/scrollreveal@4.0.0/dist/scrollreveal.min.js"></script>
    <script src="sound-detector/dist/jquery.min.js"></script>
    <script src="sound-detector/dist/script.js"></script>
</head>
                ...
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            ...
                            <img src="../img/logo-signalfx.svg" width="200px"/>
                                <p class="hero-paragraph is-revealing">The best way to understand is to participate.<br>Become a metric!</p>
                                <div class="hero-form newsletter-form field field-grouped is-revealing">
                                    <img src="../img/clap.svg" width="170px"/>
                                </div>
                            </div>
                        </div>
